import { handleQueueUpdate } from '../content-scripts/ce-do/ce-do-core.js';
...
describe('Tests for functions in ce-do-core.js content script', () => {
  ...
  describe('handleQueueUpdate', () => {
    ...
    it('should navigate to the "done" page when the queue is empty', async () => {
      ...
      expect(window.location).toBe('https://www.clickcritters.com/clickexchange.php?act=choose#done');
    });
  });
});